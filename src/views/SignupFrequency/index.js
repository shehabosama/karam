            ...
            <View style={{ flex: 2, backgroundColor: '#fff' }}>
                <View style={gloable.container}>
                    ...
                    <ScrollView contentContainerStyle={{ flexGrow: 1 ,  }}>
                        ...
                        <SwitchSelector style={{ marginTop: 50,}} backgroundColor='#F3F3F3' options={options} initial={1} selectedColor='#fff'  selectedTextStyle={{fontWeight:"bold"}} buttonColor={Colors.primary}
